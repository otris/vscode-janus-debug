...
* @member {Documents.PropertyCache} propCache
* @instance
**/
...
* @returns {Documents.SystemUserIterator} SystemUserIterator containing a list of SystemUser
...
* @returns {Documents.AccessProfile} AccessProfile or null in case of an empty AccessProfileIterator
* @since ELC 3.50b / otrisPORTAL 5.0b 
**/
...
* @returns {Documents.AccessProfile} AccessProfile or null if end of AccessProfileIterator is reached. 
* @since ELC 3.50b / otrisPORTAL 5.0b 
**/
...
* @returns {Documents.ArchiveConnectionBlob} ArchiveConnectionBlob or NULL, if failed 
...
* @returns {Documents.ArchiveConnectionBlobIterator} ArchiveConnectionBlobIterator or NULL, if failed 
* @since ELC 3.60h / otrisPORTAL 6.0h
* @example
...
* @returns {Documents.ArchiveConnectionBlob} ArchiveConnectionBlob or null in case of an empty ArchiveConnectionBlobIterator
* @since ELC 3.60h / otrisPORTAL 6.0h 
**/
...
* @returns {Documents.ArchiveConnectionBlob} ArchiveConnectionBlob or NULL if end of ArchiveConnectionBlobIterator is reached 
* @since ELC 3.60h / otrisPORTAL 6.0h 
**/
...
declare namespace Documents {
/**
* @interface ArchiveFileResultset
...
* @returns {Documents.DocFile} DocFile, null in case of an empty ArchiveFileResultset, throws an exception on error loading archive file. 
...
* @returns {Documents.DocFile} DocFile or null if end of ArchiveFileResultset is reached. 
...
* @returns {Documents.DocFile} DocFile, null if end of ArchiveFileResultset is reached, throws an exception on error loading archive file. 
* @since ELC 3.60i / otrisPORTAL 6.0i 
**/
...
* @returns {Documents.ArchiveConnection} ArchiveConnection object if successful, NULL in case of any error 
* @since DOCUMENTS 5.0a 
**/
...
* @returns {Documents.AccessProfile} ArchiveServer or null in case of an empty ArchiveServerIterator
* @since DOCUMENTS 5.0a 
**/
first(): Documents.AccessProfile;
/**
...
* @returns {Documents.AccessProfile} ArchiveServer or null if end of ArchiveServerIterator is reached. 
* @since DOCUMENTS 5.0a 
**/
next(): Documents.AccessProfile;
/**
...
* @member {Documents.Document} document
* @instance
**/
...
* @member {Documents.FileResultset} folderFiles
* @instance
**/
...
* @member {Documents.Register} register
* @instance
**/
...
* @member {Documents.ArchiveFileResultset} selectedArchiveFiles
* @instance
**/
...
* @member {Documents.DocumentIterator} selectedDocuments
* @instance
**/
...
* @member {Documents.FileResultset} selectedFiles
* @instance
**/
...
* @returns {Documents.AccessProfile} AccessProfile object as a representation of the access profile in DOCUMENTS, null in case of any error 
* @since ELC 3.60i / otrisPORTAL 6.0i
* @example
...
* @returns {Documents.ArchiveServer} New created ArchiveServer object or null if failed. 
* @since DOCUMENTS 5.0a
* @example
...
* @returns {Documents.DocFile} New created file as DocFile object or null if failed. 
...
* @returns {Documents.Folder} New created folder as Folder object or null if failed. 
...
* @returns {Documents.AccessProfileIterator} AccessProfileIterator object with all AccessProfile in DOCUMENTS 
...
* @returns {Documents.ArchiveServer} ArchiveServer object or null if failed. 
* @since DOCUMENTS 5.0a
* @example
...
* @returns {Documents.FolderIterator} FolderIterator containing a list of all folders matching the specified name pattern 
* @since ELC 3.50l01 / otrisPORTAL 5.0l01
* @example
...
* @returns {Documents.DocQueryParams} A DocQueryParams object on success, otherwise null. 
* @since DOCUMENTS 4.0c
* @example
...
* @description Note: This function requires a full workflow engine license, it does not work with pure submission lists. 
* @returns {Documents.ControlFlow} ControlFlow or null in case of an empty ControlFlowIterator
* @since ELC 3.51e / otrisPORTAL 5.1e 
**/
...
* @description Note: This function requires a full workflow engine license, it does not work with pure submission lists. 
* @returns {Documents.ControlFlow} ControlFlow or null if end of ControlFlowIterator is reached. 
* @since ELC 3.51e / otrisPORTAL 5.1e 
**/
...
* @returns {Documents.CustomProperty} CustomProperty or null in case of an empty CustomPropertyIterator
* @since DOCUMENTS 4a 
**/
...
* @returns {Documents.CustomProperty} CustomProperty or NULL if end of CustomPropertyIterator is reached 
* @since DOCUMENTS 4a 
**/
...
* (@link See table in html documentation)
**/
...
* @returns {Documents.DocFile} DocFile object representing the copied file 
* @since ELC 3.51c / otrisPORTAL 5.1c
* @example
* var docFile = context.file;
...
* @returns {Documents.SystemUser} SystemUser object representing the user who owns the file 
...
* @returns {Documents.DocFile} DocFile
* @since EAS: Documents 4.0
* @example
...
* @returns {Documents.DocFile} DocFile object representing the referred file 
* @since ELC 3.51c / otrisPORTAL 5.1c 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files
* @example
* var docFile = context.file;
...
* @returns {Documents.Register} Register object representing the desired register 
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files 
...
* @param {boolean} checkAccessRight optional boolean value, that indicates if the access rights should be considered. 
* @returns {Documents.RegisterIterator} RegisterIterator with all registers (matching the filter) 
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files 
* @since DOCUMENTS 5.0c (new optional parameter checkAccessRight) 
...
* @returns {Documents.RetrievalField} A RetrievalField object, which contains a search field name, an operator and (sometimes) a value expression. 
* @since DOCUMENTS 4.0c 
**/
...
* @returns {Documents.RetrievalSource} A RetrievalSource object on success, otherwise null. 
* @since DOCUMENTS 4.0c 
**/
...
* @returns {Documents.Document} Document or null in case of an empty DocumentIterator
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files 
**/
...
* @returns {Documents.Document} Document or null if end of DocumentIterator is reached. 
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files 
**/
...
* @returns {Documents.DOMCharacterData} The new text node. 
* @since DOCUMENTS 4.0c 
**/
...
* @member {Documents.DOMElement} documentElement
* @instance
**/
...
* @returns {Documents.DOMNodeList} A dynamic list of the found elements. 
* @since DOCUMENTS 4.0c 
* @see DOMNodeList. 
**/
...
* @returns {Documents.DOMAttr} The object, which represents the attribute in the DOM. If no attribute of the given name exists, the value is null. 
**/
...
* @returns {Documents.DOMNode} The node, respectively null, if no node with the name is in the map. 
* @since DOCUMENTS 4.0c 
**/
...
* @returns {Documents.DOMNode} The requested DOMNode Object. If the index is invalid, the method returns null. 
* @since DOCUMENTS 4.0c 
**/
...
* @returns {Documents.DOMNode} The removed node. 
* @since DOCUMENTS 4.0c 
**/
...
* @member {Documents.DOMNamedNodeMap} attributes
* @instance
**/
...
* @member {Documents.DOMNodeList} childNodes
* @instance
**/
...
* @member {Documents.DOMNode} firstChild
* @instance
**/
...
* @member {Documents.DOMNode} lastChild
* @instance
**/
...
* @member {Documents.DOMNode} nextSibling
* @instance
**/
...
* @member {Documents.DOMDocument} ownerDocument
* @instance
**/
...
* @member {Documents.DOMNode} parentNode
* @instance
**/
...
* @member {Documents.DOMNode} previousSibling
* @instance
**/
...
* @returns {Documents.DOMNode} The copy. The actual type equals the type of this. 
* @since DOCUMENTS 4.0c 
**/
...
* @returns {Documents.DOMNode} The DOMNode at the requested index. In the case of an invalid index the return value is null. 
* @since DOCUMENTS 4.0c 
**/
item(index: number): Documents.DOMNode;
}
...
* @returns {Documents.DocFile} DocFile or null in case of an empty FileResultset
* @since ELC 3.50 / otrisPORTAL 5.0
* @example
...
* @returns {Documents.DocFile} DocFile or null if end of FileResultset is reached. 
* @since ELC 3.60j / otrisPORTAL 6.0j 
**/
last(): Documents.DocFile;
/**
...
* @returns {Documents.Folder} Folder object generated by the function call 
* @since ELC 3.50l01 / otrisPORTAL 5.0l01 
**/
...
* @returns {Documents.UserAction} UserAction object representing the user-defined action. 
* @since DOCUMENTS 4.0d
* @example
...
* @returns {Documents.FileResultset} FileResultset containing a list of all DocFile objects stored in the Folder
* @since ELC 3.51b / otrisPORTAL 5.1b 
**/
...
* @returns {Documents.FolderIterator} FolderIterator with all subfolders one hierarchical level below the given Folder
* @since ELC 3.50l01 / otrisPORTAL 5.0l01 
**/
...
* @returns {Documents.Folder} Folder or null in case of an empty FolderIterator
* @since ELC 3.50l01 / otrisPORTAL 5.0l01 
**/
...
* @returns {Documents.Folder} Folder or null if end of FolderIterator is reached. 
* @since ELC 3.50l01 / otrisPORTAL 5.0l01 
**/
...
* @returns {Documents.DocHit} DocHit object or null if the position is out of bounds. 
* @since DOCUMENTS 4.0b 
**/
...
declare var propCache: Documents.PropertyCache;
...
* @returns {Documents.DocumentIterator} DocumentIterator containing the Document objects stored on the Register
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files
* @example
* var docFile = context.file;
...
* @returns {Documents.FileResultset} FileResultset containing a list of all DocFile objects linked to the register. 
* @since DOCUMENTS 4.0b
* @example
* var docFile = context.file;
...
* @returns {Documents.Register} Register or null in case of an empty RegisterIterator
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files 
**/
...
* @returns {Documents.Register} Register or null if end of RegisterIterator is reached. 
* @since ELC 3.50n / otrisPORTAL 5.0n 
* @since ELC 3.60i / otrisPORTAL 6.0i available for archive files 
**/
...
* @returns {Documents.AccessProfileIterator} AccessProfileIterator containing a list of all AccessProfiles which are assigned to the user; null in case of any error 
* @since ELC 3.50b / otrisPORTAL 5.0b 
**/
...
* @returns {Documents.SystemUser} SystemUser object representing the superior or null if no superior available 
* @since ELC 3.50b / otrisPORTAL 5.0b 
**/
...
* @returns {Documents.SystemUser} SystemUser or null in case of an empty SystemUserIterator
* @since ELC 3.50b / otrisPORTAL 5.0b 
**/
...
* @returns {Documents.SystemUser} SystemUser or null if end of SystemUserIterator is reached. 
* @since ELC 3.50b / otrisPORTAL 5.0b 
**/
...
* @description Note: This function requires a full workflow engine license, it does not work with pure submission lists. 
* @returns {Documents.ControlFlowIterator} ControlFlowIterator containing the outgoing ControlFlows of the current WorkflowStep object. 
* @since ELC 3.51e / otrisPORTAL 5.1e 
**/
...
* @returns {Documents.WorkflowStep} WorkflowStep or null in case of an empty WorkflowStepIterator
* @since ELC 3.51e / otrisPORTAL 5.1e 
**/
...
* @returns {Documents.WorkflowStep} WorkflowStep or null if end of WorkflowStepIterator is reached. 
* @since ELC 3.51e / otrisPORTAL 5.1e 
**/
...
* @member {Documents.File} responseFile
* @instance
**/
